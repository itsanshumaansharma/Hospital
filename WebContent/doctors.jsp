...
{ 
 ...
 { 
  ...
  ResultSet rs=smt.executeQuery("select * from doctors where lower(docid)='"+t1.toLowerCase()+"'"); 
 %> 
     <style>
        body {
...
<%}    
 ...
 { 
  ...
  { 
   Class.forName("oracle.jdbc.driver.OracleDriver"); 
   Connection conn=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "hospital", "hospital"); 
   PreparedStatement psmt=conn.prepareStatement("delete from doctors where docid=?"); 
   psmt.setString(1,t1); 
   psmt.executeQuery(); 
 ...
 { 
  ...
  { 
   Class.forName("oracle.jdbc.driver.OracleDriver"); 
   Connection conn=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "hospital", "hospital"); 
   PreparedStatement psmt=conn.prepareStatement("update doctors set docname=?,docmobile=?,docemail=?,docadd=?,docpass=?,docuser=? where docid=?"); 
   psmt.setString(7,t1); 
   psmt.setString(1,t2); 
   psmt.setString(2,t3); 
   psmt.setString(3,t4); 
