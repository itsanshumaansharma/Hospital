...
{ 
 ...
 { 
  ...
  ResultSet rs=smt.executeQuery("select * from test where lower(tid)='"+t1.toLowerCase()+"'"); 
 %> 
    <style>
        body {
...
<%}    
 ...
 { 
  ...
  { 
   Class.forName("oracle.jdbc.driver.OracleDriver"); 
   Connection conn=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "hospital", "hospital"); 
   PreparedStatement psmt=conn.prepareStatement("delete from test where tid=?"); 
   psmt.setString(1,t1); 
   psmt.executeQuery(); 
 ...
 { 
  ...
  { 
   Class.forName("oracle.jdbc.driver.OracleDriver"); 
   Connection conn=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "hospital", "hospital"); 
   PreparedStatement psmt=conn.prepareStatement("update test set tname=?,ttype=?,tdesc=?,tpatid=?,tcost=?,treport=? where tid=?"); 
   psmt.setString(7,t1); 
   psmt.setString(1,t2); 
   psmt.setString(2,t3); 
   psmt.setString(3,t4); 
