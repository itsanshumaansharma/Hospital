...
{ 
 ...
 { 
  ...
  ResultSet rs=smt.executeQuery("select * from appointments where lower(appid)='"+t1.toLowerCase()+"'"); 
 %> 
 <style>
        body {
...
{ 
 ...
 { 
  ...
  Connection conn=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "hospital","hospital"); 
  Statement smt=conn.createStatement(); 
  ResultSet rs=smt.executeQuery("select * from appointments"); 
 %> 
  <style>
        body {
            font-family: Arial, sans-serif;
...
<%}    
 ...
 { 
  ...
  { 
   Class.forName("oracle.jdbc.driver.OracleDriver"); 
   Connection conn=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "hospital", "hospital"); 
   PreparedStatement psmt=conn.prepareStatement("delete from appointments where appid=?"); 
   psmt.setString(1,t1); 
   psmt.executeQuery(); 
 ...
 { 
  ...
  { 
   Class.forName("oracle.jdbc.driver.OracleDriver"); 
   Connection conn=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "hospital", "hospital"); 
   PreparedStatement psmt=conn.prepareStatement("update appointments set appnum=?,apptype=?,appdesc=?, appdate=?,appdocid=? where appid=?"); 
   psmt.setString(6,t1); 
   psmt.setString(1,t2); 
   psmt.setString(2,t3); 
   psmt.setString(3,t4); 
